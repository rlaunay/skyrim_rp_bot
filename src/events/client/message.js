...
module.exports = (client, message) => {
    ...
    if (command.help.admin && !message.member.hasPermission('ADMINISTRATOR')) return message.reply('Vous n\'avez pas les permissions d\'utiliser cette commande.');
    ...
    if (timeStamps.has(message.author.id)) {
        ...
        if (timeNow < cdExpiration) {
            ...
            return message.reply(`Merci d'attendre ${timeLeft.toFixed(0)} seconde(s) avant de réutiliser cette commande.`);
        }
    }
